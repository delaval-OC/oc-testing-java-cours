...
public class ConversionQuestion8et9Test {
  ...
  public void givenConversionsList_whenbatchConvert_thenCallsServiceWithCorrectArguments() {
    ...
    final ArgumentCaptor<ConversionModel> conversionModelCaptor =
        ArgumentCaptor.forClass(ConversionModel.class);
  ...
  public void givenConversionsList_whenbatchConvert_thenCallsServiceAndReturnsAnswer() {
    ...
    final Stream<String> operations =
        Arrays.asList("32. °F->°C", "10. GAL->L", "37.8 L->GAL", "0. °C->°F").stream();
    when(conversionService.calculate(any(ConversionModel.class))).then(invocation -> {
