...
public class CalculatorServiceImpl implements CalculatorService {
  ...
  private final FormattedService solutionFormatter;

  public CalculatorServiceImpl(Calculator calculator, FormattedService solutionFormatter) {
  ...
  public CalculationModel calculate(CalculationModel calculationModel) {
    ...
    switch (type) {
      case ADDITION:
        response =
            calculator.add(calculationModel.getLeftArgument(), calculationModel.getRightArgument());
        break;
      case SUBTRACTION:
        response =
        ...
        break;
      case MULTIPLICATION:
        response = calculator.multiply(calculationModel.getLeftArgument(),
